...
class MainWindow:
    def __init__(self):    
        ...
        #open webcam.... '0' corresponds to the webcam input,,, looking to make a dropdown on middle click to select source
        self.stream = VideoStream(0)
        self.stream.start()
        #set latency defaults cor loading? maybe
        self.stop = False
        ...
        #makes the window draggable when left click is held and moved
